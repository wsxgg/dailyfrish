...
class GoodsType(BaseModel):
    ...
    image = models.ImageField(upload_to='type', verbose_name='产品类型图片')
...
class GoodsSKU(BaseModel):
    ...
    unite = models.CharField(max_length=20, verbose_name='产品单位')
    image = models.ImageField(upload_to='goods', verbose_name='产品图片')
...
class Goods(BaseModel):
    ...
    detail = HTMLField(blank=True, verbose_name='商品详细')
