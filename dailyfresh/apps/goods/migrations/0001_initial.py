# Generated by Django 2.1 on 2020-04-09 04:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail', tinymce.models.HTMLField(blank=True, verbose_name='商品详细')),
            ],
            options={
                'verbose_name': '商品SPU',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ctock', models.IntegerField(default=1, verbose_name='商品库存')),
                ('sales', models.IntegerField(default=0, verbose_name='销量')),
                ('status', models.SmallIntegerField(choices=[(0, '下线'), (1, '下线')], default=1, verbose_name='商品状态')),
